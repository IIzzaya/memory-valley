			...
			<div className='grid grid-cols-[0%_25%_75%] relative'>
				<div className='sticky top-0 h-screen flex items-start z-20 pointer-events-none'>
					...
					>
						...
						<div className='text-2xl md:text-3xl xl:text-4xl pr-6'>@长沙</div>
					</div>
				</div>
				...
				<div className='grid gap-2 relative z-10'>
					...
					{[
						'/images/20190628_1.jpg',
						'/images/20190628_2.jpg',
						'/images/20190628_3.jpg',
						'/images/20190628_4.jpg',
						'/images/20190628_5.jpg',
					].map((src) => (
