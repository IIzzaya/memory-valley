	...
	return (
		<ReactLenis root>
			<div className="grid grid-cols-[0%_25%_75%] relative">
				...
				>
					<TextAnimation
						className="text-3xl max-w-md mx-auto font-medium capitalize"
						text="偶遇知乎诊所就诊"
						variants={{
				...
				<div className="grid gap-2 relative z-10">
					...
					{[
						"/images/20180401_1.jpg",
						"/images/20180401_2.jpg",
						"/images/20180401_3.jpg",
						"/images/20180401_4.jpg",
						"/images/20180401_5.jpg",
					].map((src) => (
